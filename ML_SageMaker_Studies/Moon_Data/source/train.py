...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=2, metavar='IN',
                        help='number of input nodes for neural network (default:2)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='H',
                        help='number of nodes in the hidden layer of neural network (default:10)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='number of output nodes for neural network (default:1)')
    ...
    criterion = nn.BCELoss()  # Binary Cross Entropy see https://pytorch.org/docs/stable/nn.html for loss functions
